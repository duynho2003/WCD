 ...
 */
package com.mytech.usermanagement.filters;

import com.mytech.usermanagement.warppers.AppRequestWrapper;
import com.mytech.usermanagement.warppers.AppResponseWrapper;
...
public class UserCheckFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("UserCheckFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("UserCheckFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("UserCheckFilter:doFilter()");
        }
        
        HttpServletRequest httpRequest = (HttpServletRequest) request;
        HttpServletResponse httpResponse = (HttpServletResponse) response;
        
        String orgin = httpRequest.getRequestURI();
        System.out.println("Request URI: " + orgin);
        
        if(orgin.contains("/login")) {
            System.out.println("Is login page request");
        ...
        // include requests.
        AppRequestWrapper wrappedRequest = new AppRequestWrapper((HttpServletRequest) request);
        AppResponseWrapper wrappedResponse = new AppResponseWrapper((HttpServletResponse) response);
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("UserCheckFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("UserCheckFilter()");
        }
        StringBuffer sb = new StringBuffer("UserCheckFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("UserCheckFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("UserCheckFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("UserCheckFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("UserCheckFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("UserCheckFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
