...
public class CustomerDAO {
    ...
    static final String DELETE_CUSTOMER_BY_ID = "DELETE FROM Customers WHERE id = ?";
    ...
    public void deleteCustomer(int id){
        ...
        try{
            connection = DbConnector.getConnection();
            PreparedStatement preparedStatementStatement = connection.prepareStatement(DELETE_CUSTOMER_BY_ID);
